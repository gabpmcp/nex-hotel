...
type EnvKey = 'DATABASE_URL' | 'PORT' | 'ENVIRONMENT' | 'DB_PORT' | 'POSTGRES_DB' | 'POSTGRES_USER' | 'POSTGRES_PASSWORD' | 'DECISION_KEY';
...
export const getDecisionKey = (): string => getEnv('DECISION_KEY', '');
